...
namespace LinuxClient
{
	public partial class LoginDialog
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget LinuxClient.LoginDialog
			this.Name = "LinuxClient.LoginDialog";
			this.Title = global::Mono.Unix.Catalog.GetString ("dialog1");
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child LinuxClient.LoginDialog.VBox
			global::Gtk.VBox w1 = this.VBox;
			w1.Name = "dialog1_VBox";
			w1.BorderWidth = ((uint)(2));
			// Internal child LinuxClient.LoginDialog.ActionArea
